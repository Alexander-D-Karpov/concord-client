...
const IncomingCallOverlay: React.FC = () => {
    ...
    return (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm animate-fade-in">
            <div className="bg-dark-800 border border-gray-200 dark:border-dark-600 rounded-2xl shadow-2xl p-8 flex flex-col items-center space-y-6 animate-scale-in max-w-sm w-full">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white text-center break-words max-w-full">
                        {displayName}
                    </h2>
                ...
                <div className="flex items-center space-x-6 w-full justify-center">
                    <div className="flex flex-col items-center space-y-2">
                        <button
                            onClick={declineCall}
                            className="w-16 h-16 bg-red-500 hover:bg-red-600 text-gray-900 dark:text-white rounded-full transition shadow-lg flex items-center justify-center transform hover:scale-110"
                            title="Decline"
                        >
                        ...
                        <span className="text-xs text-gray-500 dark:text-dark-400">Decline</span>
                    </div>

                    <div className="flex flex-col items-center space-y-2">
                        <button
                            onClick={() => handleAccept(true)}
                            className="w-16 h-16 bg-green-500 hover:bg-green-600 text-gray-900 dark:text-white rounded-full transition shadow-lg flex items-center justify-center transform hover:scale-110"
                            title="Accept Audio"
                        >
                            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                        ...
                        <span className="text-xs text-gray-500 dark:text-dark-400">Audio</span>
                    </div>
                </div>
            </div>
        </div>
