...
const VideoGrid: React.FC<VideoGridProps> = ({
    ...
    useEffect(() => {
        const handleKeyDown = (e: KeyboardEvent) => {
            if (e.key === 'Escape') {
                ...
                } else if (isFullscreenCall && onToggleFullscreen) {
                    onToggleFullscreen();
                }
            }
        };
    ...
    }, [expandedTileKey, isFullscreenCall, onToggleFullscreen]);
            ...
            <div className={containerClass}>
                {isFullscreenCall && (
                    <div className="absolute top-4 left-4 right-4 z-20 flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                            {expandedTileKey && (
                                <button
                                    onClick={() => setExpandedTileKey(null)}
                                    className="px-3 py-2 bg-dark-800/80 hover:bg-dark-700 text-white rounded-lg transition backdrop-blur-sm flex items-center space-x-2"
                                    title="Back to grid"
                                >
                        ...
                        <button
                            ...
                            className="px-3 py-2 bg-dark-800/80 hover:bg-red-600 text-white rounded-lg transition backdrop-blur-sm flex items-center space-x-2"
                ...
                {expandedTileKey && !isFullscreenCall && (
                    <div className="absolute top-2 left-2 z-20">
                        <button
                            onClick={() => setExpandedTileKey(null)}
                            className="px-3 py-1.5 bg-dark-800/90 hover:bg-dark-700 text-white rounded-lg transition backdrop-blur-sm flex items-center space-x-1.5 text-sm"
                        >
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                            </svg>
